...
let domain = process.env.NODE_ENV === 'development' ? 'm.gcox-test.lab.ssss.so' : location.host.split(':')[0]
//let domain = process.env.NODE_ENV === 'development' ? 'm.gcox.sg' : location.host.split(':')[0]
