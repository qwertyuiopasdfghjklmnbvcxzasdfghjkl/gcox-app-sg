export default {
    ...
    "certificate": {"Papot": "Passport", "NaId": "National ID card", "Drli": "Driver's license"},
    "update": {
    ...
    "find": {"loginNow": "Login Now", "registerSucess": "Register Success", "newReg": "Register"},
    "beta": {
    ...
    "otc_ad": {
        ...
        "price_no_more_than_tip": "Your AD display price will not be higher than this price",
        "trans_orders_num_tip": "Number of orders that can be traded simultaneously per ad",
        ...
        "pay_time_expired_tip": "When the payment time expires, the transaction will be cancelled and we will refund the funds to the seller.",
        ...
        "gather_bank_account_tip": "Your payment bank account as seen by your counterparty",
        "otc_ad_Bad_review": "Negative",
        "otc_cancel_ad": "End",
        "confirm_payment_time_tip": "You must mark the confirmation payment within {0} minutes, otherwise the order will be cancelled by the system",
        "otc_trade_specification": "OTC Trading Specifications",
        "otc_ad_uncompleted": "Uncompleted",
        "confirm_gather_time_tip": "The buyer of your ad must mark the payment within {0} minutes or the order will be cancelled by the system",
        "mini_trans_num_tip": "Minimum {0} amount per transaction",
        ...
        "price_no_less_than_tip": "Your AD display price will not be Lower than this price",
        "otc_ad_end_time": "End Time",
        "payment_bank_account_tip": "Your payment bank account as seen by your counterparty",
        "otc_edit_title": "{0} {1}",
        ...
        "price_fluctuation_tip": "Premium {0}% on the exchange price",
        "payment_bank_account_name_tip": "Your payment bank account name as seen by your counterparty",
        "otc_ad_minute": "Min",
        "gather_bank_name_tip": "Your payment bank name as seen by your counterparty",
        "otc_unreleased": "Unreleased",
        "otc_post_title": "{0} {1}",
        "otc_ad_Premium": "Premium",
        "max_trans_num_tip": "Maximum {0} amount per transaction",
        "payment_method_tip": "The payment method you will use",
        "otc_unit_price": "Unit Price",
        "sell_quantity_tip": "The total number of {0} you plan to sell",
        "otc_edit_ad": "Edit",
        "otc_ad_Transactional_advertis": "Post Offer",
        "gather_method_tip": "The payment method you requested",
        "otc_order": "OTC order management",
        "otc_ad_PayPal": "PayPal",
        "otc_ad_maximum_orders": "Max Order Processing",
        "payment_bank_name_tip": "Your payment bank name as seen by your counterparty",
        "otc_ad_Order_user": "Order Account",
        "favorable_rate_tip": "The positive rate of the counterparty you deal with must be greater than {0}%",
        ...
        "price_after_premium_tip": "{0} price after calculating the premium",
        "exchange_price_tip": "The current {1} / {2} price of the benchmark exchange {0} is {3}",
        "otc_ad_payment_period": "Please input the payment period",
        "otc_ad_completed": "Completed",
        "pay_method": "Pay method",
        "purchase_quantity_tip": "The total number of {0} you want to buy",
        ...
        "otc_others": "Others",
        "gather_bank_account_name_tip": "Your payment bank account name as seen by your counterparty"
    },
    "public0": {
        ...
        "text001": "In order to quickly process your withdrawal, please pay attention to the status and description of the withdrawal/withdrawal record and complete the relevant operations in time.",
        "tip": "Tips",
        "submit": "Submit",
    ...
    "nav": {"market": "Market", "trade": "Trade", "my": "My", "home": "Home"},
    "otc_legal": {
    ...
    "wallet": {"currency_valuation": "Valuation", "value_frozen": "Frozen value"},
    "business": {
    ...
    "sms_countrys": [{"invitees": "好友", "gain": "gain"}],
    "otc_exchange": {
    ...
    "gcox_otc": {
        ...
        "pay_to": "Pay to",
        "delect_ad_affirm": "Do you want to delete this AD",
        ...
        "appraisement": "Total",
        "deleted": "Deleted",
        "memo_address_use": "Only when Tag and address are used together can the recharge be successful",
    ...
    "error_code": {
        ...
        "NOT_HOLDING_CARD_AS_REQUIRED": "Hand written Bitark and date cards without request.",
        ...
        "AD_PERMISSION_DEND": "You have been restricted by the administrator",
        ...
        "AD_NO_ELIGIBLE": "No eligible Ads",
        ...
        "CUR_PRICE_ERROR": "Did not get the latest base price",
    ...
    "user": {
        ...
        "submit": "Submit",
        "idCard": "Id Number",
        "go_main_soon": "Go to GCOX.COM",
        "go_sg_soon": "Co to GCOX.SG",
        "about": "About",
        "idNumber": "Id Number",
        "chinese": "Simplified Chinese",
        "goto_rightnow": "Jump now",
        ...
        "all": "All",
        "set": "Set",
        "curr_stay": "Stay on site in current region",
        "area_chioce": "Choose a district",
        "center": "Center",
        "cn": "Country or region",
        "userName": "User Name",
        "curr_pos_sg": "Your current location ： Singapore",
        "noBind": "No Bind",
        "changePassword": "Change Password",
        "goto_sg_site": "Go to GCOX.SG",
        "realName": "KYC",
        "loginSuccess": "Login Success",
        "site": "Site",
        "no_sg_user": "You are a non-Singapore user. According to relevant policy requirements, please use",
        "hint": "Please ensure that you use your official identity for certification and we will protect your personal information.",
        "name": "Name",
        "quit": "Exit",
        "goto_desc": "This website is optimized for users in Singapore. For your comfort, we recommend that you use  GCOX.SG",
        "yes_sg_user": "You are a Singapore user. According to relevant policy requirements, please use",
        "goto_main_site": "Go to GCOX.COM",
        "curr_pos_notsg": "Your current location: non-singapore",
    },
    "Memo": [],
    "account": {
